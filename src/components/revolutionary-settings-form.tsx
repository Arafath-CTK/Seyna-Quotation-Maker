...
export default function RevolutionarySettingsForm({
  initialSettings,
}: {
  ...
  const tabs = [
    { id: 'company', label: 'Company', icon: Building2, description: 'Business information' },
    { id: 'letterhead', label: 'Letterhead', icon: FileText, description: 'Document styling' },
    { id: 'numbering', label: 'Numbering', icon: Hash, description: 'Quote sequences' },
  ];
  ...
  return (
    <div className="bg-background min-h-screen">
      ...
      <div className="border-border/50 relative overflow-hidden border-b">
        <div className="from-primary/5 via-primary/10 to-accent/5 absolute inset-0 bg-gradient-to-r"></div>
        <div className="relative mx-auto max-w-7xl px-6 py-12">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-foreground text-4xl font-bold tracking-tight">Settings</h1>
              <p className="text-muted-foreground mt-2 text-lg">
                Configure your business preferences and document styling
              </p>
            </div>
          </div>
        </div>
            ...
            {tabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`settings-tab group flex items-center gap-3 border-b-2 px-1 py-4 text-sm font-medium transition-all ${
                    isActive
                ...
                >
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-muted-foreground text-xs">{tab.description}</div>
                  </div>
                </button>
              );
            })}
      ...
      >
        {({
          ...
          <Form className="mx-auto max-w-7xl px-6 py-8">
            {/* Company Tab */}
            {activeTab === 'company' && (
              <div className="animate-in fade-in-50 space-y-8 duration-300">
                <div className="gradient-border">
                  <div className="gradient-border-inner p-8">
                    <div className="mb-8">
                      <h2 className="text-foreground text-2xl font-bold">Company Information</h2>
                    ...
                    <div className="grid gap-8 lg:grid-cols-2">
                      <div className="space-y-4">
                        ...
                        <Field
                          name="company.name"
                          className="form-input border-border bg-input text-foreground placeholder:text-muted-foreground focus:border-primary focus:ring-primary/20 w-full rounded-xl border px-4 py-3.5 text-sm focus:ring-2 focus:outline-none"
                      ...
                      <div className="space-y-4 lg:col-span-2">
                        ...
                        <Field
                          ...
                          rows={4}
                          className="form-input border-border bg-input text-foreground placeholder:text-muted-foreground focus:border-primary focus:ring-primary/20 w-full resize-none rounded-xl border px-4 py-3.5 text-sm focus:ring-2 focus:outline-none"
                      ...
                      <div className="space-y-4">
                        ...
                        <Field
                          ...
                          className="form-input border-border bg-input text-foreground focus:border-primary focus:ring-primary/20 w-full rounded-xl border px-4 py-3.5 text-sm focus:ring-2 focus:outline-none"
                        >
                          {currencies.map((c) => (
            ...
            {activeTab === 'letterhead' && (
              <div className="animate-in fade-in-50 space-y-8 duration-300">
                <div className="gradient-border">
                  <div className="gradient-border-inner p-8">
                    <div className="mb-8">
                      <h2 className="text-foreground text-2xl font-bold">Letterhead & Margins</h2>
                      <p className="text-muted-foreground mt-2">
            ...
            {activeTab === 'numbering' && (
              <div className="animate-in fade-in-50 space-y-8 duration-300">
                <div className="gradient-border">
                  <div className="gradient-border-inner p-8">
                    <div className="mb-8">
                      <h2 className="text-foreground text-2xl font-bold">Quote Numbering</h2>
                      <p className="text-muted-foreground mt-2">
                    ...
                    <div className="grid gap-8 lg:grid-cols-2">
                      ...
                      <div className="flex flex-col justify-center space-y-6">
                        <div className="border-border bg-muted/30 flex items-center justify-between rounded-xl border p-6">
                          <div>
                            <label className="text-foreground text-sm font-semibold">
            ...
            {/* Sticky Save Section */}
            <div className="border-border/50 bg-background/95 sticky bottom-0 z-40 mt-12 border-t backdrop-blur-sm">
              <div className="mx-auto max-w-7xl px-6 py-6">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    {status === 'saved' && (
                      <div className="text-success flex items-center gap-3 text-sm">
                  ...
                  <button
                    ...
                    className="bg-primary text-primary-foreground shadow-primary/25 hover:bg-primary/90 hover:shadow-primary/30 focus:ring-primary/20 inline-flex items-center gap-3 rounded-xl px-8 py-3.5 text-sm font-semibold shadow-lg transition-all duration-200 hover:shadow-xl focus:ring-2 focus:ring-offset-2 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50 disabled:shadow-none"
                  >
                    {isSubmitting ? (
                      <>
